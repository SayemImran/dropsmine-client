...
export default function NotFound() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(192,132,252,0.28),_transparent_30%),linear-gradient(135deg,_#020617_0%,_#111827_50%,_#312e81_100%)]">
        ...
        <div className="w-full max-w-3xl rounded-[2rem] border border-white/15 bg-white/10 px-8 py-12 shadow-2xl shadow-slate-950/40 backdrop-blur-2xl">
          ...
          <div className="grid gap-6 sm:grid-cols-[1.5fr_1fr] items-center">
            <div>
              ...
              <Link
                href="/"
                className="inline-flex items-center justify-center rounded-full border border-white/20 bg-white/10 px-6 py-3 text-sm font-medium text-white shadow-lg shadow-white/20 transition hover:bg-white/20"
              >
                Go back home
              </Link>
            </div>
